...
--
-- Table structure for table `medals_user`
--

DROP TABLE IF EXISTS `medals_user`;
...
CREATE TABLE `medals_user` (
  ...
  CONSTRAINT `medals_user_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `medals_user_ibfk_2` FOREIGN KEY (`medal_id`) REFERENCES `medals` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `medals_user`
--

LOCK TABLES `medals_user` WRITE;
/*!40000 ALTER TABLE `medals_user` DISABLE KEYS */;
INSERT INTO `medals_user` VALUES (1,'91195351-4907-46c8-b9b8-32260a1dd88c',42,1,'2025-06-08 19:19:33','2025-06-08 19:19:33','2025-06-08 19:19:33',NULL),(2,'8c00a821-c067-4e4d-9137-51745a45783f',42,2,'2025-06-08 19:19:33','2025-06-08 19:19:33','2025-06-08 19:19:33',NULL),(3,'a234c5fc-54e6-4e76-ad1f-7e51447b462a',43,1,'2025-06-08 19:19:33','2025-06-08 19:19:33','2025-06-08 19:19:33',NULL),(4,'dbb0df0f-8c09-434b-81ab-5f85cc1096a8',43,2,'2025-06-08 19:19:33','2025-06-08 19:19:33','2025-06-08 19:19:33',NULL);
/*!40000 ALTER TABLE `medals_user` ENABLE KEYS */;
UNLOCK TABLES;
